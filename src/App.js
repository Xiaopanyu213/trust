...
const coins = [
  ...
  { id: "usd-coin", symbol: "USDC", name: "USDC", icon: "https://cryptologos.cc/logos/usd-coin-usdc-logo.png" },
];
...
export default function App() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '20px' }}>
      <div ref={walletRef} style={{ width: '320px', borderRadius: '20px', backgroundColor: 'white', padding: '16px', boxShadow: '0 4px 6px rgba(0,0,0,0.1)' }}>
